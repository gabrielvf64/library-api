...
INSERT INTO
    LOANS (CUSTOMER_ID, LOAN_DATE, EXPECTED_RETURN_DATE, RETURN_DATE, STATUS) --STATUS 0-ACTIVE, 1-OVERDUE, 2-FINISHED
VALUES
    (1, CURRENT_DATE, DATEADD(DAY, 3, CURRENT_DATE), NULL, 0),
    (2, '2025-02-04', '2025-02-07', '2025-02-07', 2),
    (3, '2025-02-10', '2025-02-13', NULL, 1);
