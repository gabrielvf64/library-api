...
VALUES
    ...
    (2, ARRAY[3,6], CURRENT_DATE, DATEADD(DAY, 3, CURRENT_DATE), NULL, 1),
    (3, ARRAY[4,5], CURRENT_DATE, DATEADD(DAY, 3, CURRENT_DATE), NULL, 2),
    (4, ARRAY[10,7], CURRENT_DATE, DATEADD(DAY, 3, CURRENT_DATE), NULL, 1),
    (5, ARRAY[30,15], CURRENT_DATE, DATEADD(DAY, 3, CURRENT_DATE), NULL, 1),
    (6, ARRAY[22,20], CURRENT_DATE, DATEADD(DAY, 3, CURRENT_DATE), NULL, 1),
    (7, ARRAY[14,11], CURRENT_DATE, DATEADD(DAY, 3, CURRENT_DATE), NULL, 1);
